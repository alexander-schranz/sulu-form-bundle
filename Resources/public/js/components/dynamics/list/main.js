...
define(['jquery'], function ($) {
    ...
    var constants = {
        ...
        toolbarKey: 'dynamics',
        listId: 'dynamic-list',
        endPointUrl: '/admin/api/l91/form/dynamics',
        fieldsAction: '/admin/api/l91/form/dynamics/fields'
    };
                                    ...
                                    export: {
                                        options: {
                                            ...
                                            callback: function() {
                                                ...
                                                App.start([{
                                                    name: 'csv-export@l91suluform',
                                                    options: csvOptions
                                                }]).fail(function() {
                                                    // Fallback to old version of csv-export
                                                    // aura_1: Error loading component: csv-export@l91suluform Error: Script error for: __component__$csv-export@l91suluform
