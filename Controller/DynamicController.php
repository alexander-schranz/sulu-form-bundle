...
class DynamicController extends RestController implements ClassResourceInterface
{
    ...
    {
        $repository = $this->get('l91_sulu_form.repository.dynamic');
        ...
        $entries = $this->get('l91_sulu_form.list_builder.dynamic_list_factory')->build($entries, $view);
    ...
    public function cgetFieldsAction(Request $request)
    {
        ...
        $fieldDescriptors = $this->get('l91_sulu_form.list_builder.dynamic_list_factory')
